	...
	public function autocomplete() {
		...
		if (isset($this->request->get['filter_name']) || isset($this->request->get['filter_model'])) {
			...
			foreach ($results as $result) {
                ...
                // Ajax Live Options + Percentage Option
                if($this->config->get('live_options_ajax_status')){
                    // Show Option Price
                    if($product_option_value['price_prefix'] == '+%' || $product_option_value['price_prefix'] == '-%'){
                        $product_option_value['price'] = $product_option_value['price'] * ( $result['price']/100 );
                        $product_option_value['price_prefix'] = substr($product_option_value['price_prefix'], 0, 1);
                    }
                }
